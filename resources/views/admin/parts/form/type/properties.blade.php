        ...
        @if(isset($item->properties))
            ...
            <tr>
              <td>
                <input type="text"
                       ...
                       title="properties[{{ $prop->id }}][name] -> {{ $column['type'] }}"
                       class="form-control"
                       value="{{ $prop->name }}">
              ...
              <td>
                <input type="text"
                       ...
                       title="properties[{{ $prop->id }}][value] -> {{ $column['type'] }}"
                       class="form-control"
                       value="{{ $prop->value }}">
              </td>
              <td>
                <input name="properties[{{ $prop->id }}][delete_property]"
                       title="properties[{{ $prop->id }}][delete_property] -> {{ $column['type'] }}"
          ...
          @empty
            <tr>
              <td>
                <input type="text"
                       name="properties[new_0][name]"
                       title="properties[new_0][name]"
                       class="form-control">
                <input type="hidden"
                       name="properties[new_0][product_id]"
                       value="{{ $item->id }}">
              </td>
              <td>
                <input type="text"
                       name="properties[new_0][value]"
                       title="properties[new_0][value]"
                       class="form-control">
              </td>
              <td>Добавить</td>
            </tr>
